...
stridedbatchgemm_forward(const int batchSize,
                         const int m,
                         const int n,
                         const int k,
                         const float alpha,
    ...
    StridedBatchGemm<T> _sbgemm = StridedBatchGemm<T>(
        typename StridedBatchGemm<T>::Config(
            batchSize,
            m,
            n,
            k,
...
template<typename T>
std::vector<torch::Tensor>
stridedbatchgemm_backward(const int batchSize,
                          const int m,
                          const int n,
                          const int k,
                          const float alpha,
