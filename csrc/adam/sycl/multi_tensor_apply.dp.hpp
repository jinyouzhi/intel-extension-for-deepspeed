    ...
    for (int t = 0; t < ntensors; t++) {
        ...
        for (int chunk = 0; chunk < chunks_this_tensor; chunk++) {
            ...
            if (tensors_full || blocks_full || last_chunk) {
                ...
                /*TODO guokai: port this multi_tensor_apply_kernel call*/
                ...
                stream->submit([&](sycl::handler& cgh) {
                    ...
                    cgh.parallel_for(
                        sycl::nd_range<1>(loc_block_info * block_size, block_size),
                ...
                /*
                DPCT1010:0: SYCL uses exceptions to report errors and does not use the error codes.
                The call was replaced with 0. You need to rewrite this code.
                */
                //TODO guokai AT_CUDA_CHECK(0);
