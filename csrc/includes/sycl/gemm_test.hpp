...
public:
    ...
    std::array<int, 3> TestAlgo(int loops)
    {
        ...
        int algo_bw1 = Run(loops, [=](int algo) {
            ...
            // B need to transpose.
            cublasOperation_t op_b = (transb == oneapi::mkl::transpose::trans ? oneapi::mkl::transpose::nontrans : oneapi::mkl::transpose::trans);
        ...
        int algo_bw2 = Run(loops, [=](int algo) {
            // A need to transpose.
            cublasOperation_t op_a = (transa == oneapi::mkl::transpose::trans ? oneapi::mkl::transpose::nontrans : oneapi::mkl::transpose::trans);
